//! SiliconFlow API client and Rig integration
//!
//! # Example
//! ```
//! use rig::providers::siliconflow;
//!
//! let client = siliconflow::Client::new("YOUR_API_KEY");
//!
//! let deepseek_vl = client.completion_model(siliconflow::DEEPSEEK_VL);
//! let flux_model = client.image_generation_model(siliconflow::FLUX_1_DEV);
//! ```
...
// ================================================================
// Main SiliconFlow Client
// ================================================================
const SILICONFLOW_API_BASE_URL: &str = "https://api.siliconflow.com/v1";
...
impl Client {
    /// Create a new SiliconFlow client builder.
    ///
    /// # Example
    /// ```
    /// use rig::providers::siliconflow::{ClientBuilder, self};
    ///
    /// // Initialize the SiliconFlow client
    /// let siliconflow = Client::builder("your-siliconflow-api-key")
    ///    .build()
    /// ```
    ...
    /// Create a new SiliconFlow client. For more control, use the `builder` method.
    ///
    /// # Panics
    ...
    pub fn new(api_key: &str) -> Self {
        Self::builder(api_key)
            .build()
            .expect("SiliconFlow client should build")
    }
...
impl ProviderClient for Client {
    ...
    fn from_env() -> Self {
        let api_key = std::env::var("SILICONFLOW_API_KEY").expect("SILICONFLOW_API_KEY not set");
        Self::new(&api_key)
    }
...
impl CompletionClient for Client {
    ...
    /// Creates a SiliconFlow completion model with the given `model_name`.
...
impl ImageGenerationClient for Client {
    type ImageGenerationModel = image_generation::ImageGenerationModel;

    /// Create an image generation model with the given name.
    ///
    /// # Example
    /// ```
    /// use rig::providers::siliconflow::{Client, self};
    ///
    /// // Initialize the SiliconFlow client
    /// let siliconflow = Client::new("your-siliconflow-api-key");
    ///
    /// let image_model = siliconflow.image_generation_model(siliconflow::STABLE_DIFFUSION_XL);
    /// ```
    fn image_generation_model(&self, model: &str) -> Self::ImageGenerationModel {
        image_generation::ImageGenerationModel::new(self.clone(), model)
    }
}
...
/// The response shape from the SiliconFlow API
...
impl completion::CompletionModel for CompletionModel {
    ...
    > {
        ...
        tracing::debug!("SiliconFlow completion request: {request:?}");
        ...
        if response.status().is_success() {
            ...
            tracing::debug!(target: "rig", "SiliconFlow completion: {}", t);
...
// ================================================================
// SiliconFlow Completion API
// ================================================================

/// DeepSeek-VL model
pub const DEEPSEEK_VL: &str = "deepseek-ai/deepseek-vl";
/// Qwen2-VL-7B-Instruct model
pub const QWEN2_VL_7B: &str = "Qwen/Qwen2-VL-7B-Instruct";
/// LLaVA-NeXT-Video-7B-hf model
pub const LLAVA_NEXT_VIDEO: &str = "llava-hf/llava-v1.6-vicuna-7b-hf";
/// Yi-VL-34B model
pub const YI_VL_34B: &str = "01-ai/Yi-VL-34B";

#[cfg(feature = "image")]
pub use image_generation::{FLUX_1_DEV, FLUX_1_SCHNELL, ImageGenerationModel, STABLE_DIFFUSION_XL};
...
mod tests {
    ...
    #[test]
    fn test_deserialize_siliconflow_response() {
        let data = r#"{
            "choices":[{
                "finish_reason": "stop",
                "index": 0,
