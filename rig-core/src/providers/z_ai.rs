...
//! # Example
//! ```
//! use rig::providers::z_ai;
//!
//! let client = z_ai::Client::new("YOUR_API_KEY");
//!
//! let gpt4 = client.completion_model(z_ai::GPT4);
//! ```
...
// Main z.ai Client
// ================================================================
const Z_AI_API_BASE_URL: &str = "https://api.z.ai/api/paas/v4";
...
impl Client {
    /// Create a new z.ai client builder.
    ///
    /// # Example
    /// ```
    /// use rig::providers::z_ai::{ClientBuilder, self};
    ///
    /// // Initialize the z.ai client
    /// let z_ai = Client::builder("your-z-ai-api-key")
    ///    .build()
    /// ```
    ...
    /// Create a new z.ai client. For more control, use the `builder` method.
    ///
    /// # Panics
...
impl ProviderClient for Client {
    ...
    fn from_env() -> Self {
        let api_key = std::env::var("Z_AI_API_KEY").expect("Z_AI_API_KEY not set");
        Self::new(&api_key)
    }
...
impl CompletionClient for Client {
    ...
    /// Creates a z.ai completion model with the given `model_name`.
...
/// The response shape from the z.ai API
...
impl completion::CompletionModel for CompletionModel {
    ...
    > {
        ...
        tracing::debug!("z.ai completion request: {request:?}");
        ...
        if response.status().is_success() {
            ...
            tracing::debug!(target: "rig", "z.ai completion: {}", t);
...
mod tests {
    ...
    #[test]
    fn test_deserialize_z_ai_response() {
        let data = r#"{
            "choices":[{
                "finish_reason": "stop",
                "index": 0,
