//! ChatGLM API client and Rig integration
//!
//! # Example
//! ```
//! use rig::providers::chatglm;
//!
//! let client = chatglm::Client::new("YOUR_API_KEY");
//!
//! let glm4 = client.completion_model(chatglm::GLM4);
//! ```
...
// Main ChatGLM Client
// ================================================================
const CHATGLM_API_BASE_URL: &str = "https://open.bigmodel.cn/api/paas/v4";
...
impl Client {
    /// Create a new ChatGLM client builder.
    ///
    /// # Example
    /// ```
    /// use rig::providers::chatglm::{ClientBuilder, self};
    ///
    /// // Initialize the ChatGLM client
    /// let chatglm = Client::builder("your-chatglm-api-key")
    ///    .build()
    /// ```
    ...
    /// Create a new ChatGLM client. For more control, use the `builder` method.
    ///
    /// # Panics
    ...
    pub fn new(api_key: &str) -> Self {
        Self::builder(api_key)
            .build()
            .expect("ChatGLM client should build")
    }
...
impl ProviderClient for Client {
    ...
    fn from_env() -> Self {
        let api_key = std::env::var("CHATGLM_API_KEY").expect("CHATGLM_API_KEY not set");
        Self::new(&api_key)
    }
...
impl CompletionClient for Client {
    ...
    /// Creates a ChatGLM completion model with the given `model_name`.
...
/// The response shape from the ChatGLM API
...
impl completion::CompletionModel for CompletionModel {
    ...
    > {
        ...
        tracing::debug!("ChatGLM completion request: {request:?}");
        ...
        if response.status().is_success() {
            ...
            tracing::debug!(target: "rig", "ChatGLM completion: {}", t);
...
// ================================================================
// ChatGLM Completion API
// ================================================================

/// `glm-4` completion model
pub const GLM4: &str = "glm-4";
/// `glm-4-air` completion model
pub const GLM4_AIR: &str = "glm-4-air";
/// `glm-4-airx` completion model
pub const GLM4_AIRX: &str = "glm-4-airx";
/// `glm-4-flash` completion model
pub const GLM4_FLASH: &str = "glm-4-flash";
...
mod tests {
    ...
    #[test]
    fn test_deserialize_chatglm_response() {
        let data = r#"{
            "choices":[{
                "finish_reason": "stop",
                "index": 0,
